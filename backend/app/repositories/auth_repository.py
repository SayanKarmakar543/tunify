...
async def register_repo(db: AsyncSession, user_request: UserRequest) -> User:
...
async def user_login_repo(db: AsyncSession, email: str, password: str) -> User:
...
async def get_user_details_repo(
    user: dict,
    db: AsyncSession
